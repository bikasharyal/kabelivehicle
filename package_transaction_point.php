...
//        echo $pickup_time; exit();
    ...
    }elseif ($passenger_count>$selected_package_row['no_of_seats']){
...
<!--                        <br>-->
        ...
        <?php if(isset($payment_signal)&& $payment_signal==true): $rate = $selected_package_row['rate']*100;?>
            <form action="./stripe_charger.php" method="post">
                ...
                <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                        ...
                        data-description="<?php echo $selected_package_row['package_title']." - Package ";?>"
