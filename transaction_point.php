...
if(!isset($_SESSION['user_token']) && !isset($_SESSION['fb_access_token']) && !isset($_SESSION['g_access_token'])){
    ...
    header("Location: vehicles.php?login_status=false");
}
...
if(isset($_GET['v_id'])){
    ...
    $selected_vehicle = Get_Vehicle_Where_con($connection, $vehicle_id); // calling Get_Vehicle_Where_con function from function.php
    $selected_vehicle_row = mysqli_fetch_array($selected_vehicle);
}
    ...
    <div class="home_search_content">
        ...
        <form autocomplete="off" action="" method="post" class="home_search_form" id="home_search_form">
            <div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
                ...
                <input type="hidden" name="vehicle_id" value="<?php if(isset($_GET['v_id'])){ echo $_GET['v_id'];} ?>">
            ...
            <div class="book_clear" style="padding: 10px; margin: 20px">
                ...
                <div style= "float: left;" >
                    ...
                    <ul>
                        <li><?php echo $selected_vehicle_row['description']; ?></li>
                        <li><?php echo "Type: ".$selected_vehicle_row['type']; ?></li>
                        <li><?php echo "Total Seats: ".$selected_vehicle_row['no_of_seats']; ?></li>
                        <li><?php echo "Per Day Rate: $".$selected_vehicle_row['price_per_day']; ?></li>
                        <li><?php echo "Air Condition: "; if($selected_vehicle_row['ac_availability']==1)echo "Yes"; else echo "No"; ?></li>
                        <li><?php echo "Air Bag: "; if($selected_vehicle_row['air_bag_availability']==1)echo "Yes"; else echo "No"; ?></li>
                        <li><?php echo "Wifi: "; if($selected_vehicle_row['wifi_availability']==1)echo "Yes"; else echo "No"; ?></li>
                        <li>With Chauffer: Yes</li>
                        <br>
                    </ul>
                    <?php if(isset($payment_signal)&& $payment_signal !=true): ?>
                    <button class="reserve_pay" type="submit" name="info_submit" style="margin-top: 10px;" >Continue</button>
                    <?php endif; ?>
        </form>
        <?php if(isset($payment_signal)&& $payment_signal==true): $rate = $selected_vehicle_row['price_per_day']*100;?>
        <form action="./stripe_charger.php" method="post">
            <input type="hidden" name="vehicle_id" value="<?php if(isset($_GET['v_id'])){ echo $_GET['v_id'];}  ?>">
            <input type="hidden" name="rate" value="<?php if(isset($rate)){ echo $rate;}  ?>">
            <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                    data-key="<?php echo $stripe['publishable_key']; ?>"
                    data-description="Renting <?php echo $selected_vehicle_row['name']." - ".$selected_vehicle_row['brand']; ?>"
